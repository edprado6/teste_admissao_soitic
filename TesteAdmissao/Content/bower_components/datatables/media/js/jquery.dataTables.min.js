...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeira",sLast:"Última",sNext:"Próxima",sPrevious:"Anterior"},sEmptyTable:"Não há dados disponíveis na tabela",sInfo:"Exibindo _START_ até _END_ de _TOTAL_ registros.",sInfoEmpty:"Exibindo 0 até 0 de 0 registros.",sInfoFiltered:"(resultados encontrados de um total de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Exibir _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro foi encontrado."},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
